  ...
  const sampleTeachers = [
    {
      ...
      shortBio: "Нейроотличный педагог (они/их), основатель платформы. Специализируется на работе с нейроотличными детьми и подростками. Использует они/их pronouns.",
    },
    {
      name: "Саша",
      slug: "sasha",
