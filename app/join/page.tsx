      ...
      <section className="bg-background border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-xl text-textSecondary max-w-3xl">
            Присоединяйтесь к нам! Мы ищем нейроотличных педагогов, специалистов
            и волонтёров
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  Мы принимаем педагогов в команду от 14 лет (если вам меньше,
                  но вы круты — пишите тоже). Можно присоединиться к любому из
                  имеющихся направлений или предложить своё.
                </p>
                <p className="text-gray-600 mb-4">
                  Направление может не совпадать по формату с теми, которые уже
                  есть на сайте. Например, вы можете вести чат, говорить по
                  телефону, параллельно играть в игру, смотреть фильм и пр.
                </p>
                <div className="bg-background rounded-xl p-4">
                  <p className="text-textPrimary font-medium">
                    💡 Вы можете присоединиться, даже если не говорите устно, но
                    свободно используете средства АДК — вы нам очень нужны!
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-md">
                ...
                <p className="text-gray-500 text-sm mt-4">
                  Также не стесняйтесь писать, если у вас есть особенности
                  речи/общения или вы считаете, что выглядите "как-то не так".
                  Мы позаботимся о подборе адекватных клиентов.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-md">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Мы просим педагогов сделать посильное пожертвование с дохода в пользу организации для оплаты",
                ...
                <div className="bg-amber-50 rounded-xl p-4 mt-4">
                  <p className="text-amber-800 text-sm">
                    <strong>Про донаты:</strong> Если проводите что-либо за
                    донат — от них ничего не вычитается, если сумма меньше 700
                    рублей. Если больше — пожалуйста, выделите часть на
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        ...
                        знакомство, обсуждение ваших интересов и опыта
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Проведение/демонстрация пробного занятия (любого по
                        одной из тем, какую хотите брать) организатору и/или
                        другому сотруднику, примерно на 30 минут
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-accent rounded-2xl p-6 text-textPrimary sticky top-24">
                ...
                <p className="text-textSecondary text-sm mb-6">
                  Заполните небольшую анкету — мы свяжемся с вами для
                  собеседования
                </p>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-md">
                ...
                <p className="text-gray-600 text-sm mb-3">Мы также ищем:</p>
                <ul className="space-y-2">
                  {[
