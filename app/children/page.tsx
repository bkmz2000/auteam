...
export default async function ChildrenPage() {
  ...
  const filtered = courses.filter((c) => c.ageGroup === "children");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <p className="text-textSecondary text-lg max-w-2xl">
              Курсы и занятия для детей примерно 5–12 лет. Сопровождение в обучении, творчество, развитие навыков общения.
            </p>
          </div>
