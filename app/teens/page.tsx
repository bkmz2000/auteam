...
export default async function TeensPage() {
  ...
  const filtered = courses.filter((c) => c.ageGroup === "teens");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <p className="text-textSecondary text-lg max-w-2xl">
              Курсы и занятия для подростков примерно 12–17 лет. Репетиторство, тренинги навыков, творческие мастерские.
            </p>
          </div>
